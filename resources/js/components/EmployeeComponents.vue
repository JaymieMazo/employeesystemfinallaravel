...
<v-row class="ma-2">
        ...
        rounded
          ...
          dense
          width="10px"
          v-model="search_Input.employee_code"
          ></v-text-field>
          </v-col>
          ...
          <v-col  cols=4>
              <v-text-field 
                    ...
                    rounded
                      ...
                      dense
                      width="10px"
                      v-model="search_Input.employee_name"></v-text-field>
          </v-col>


    <v-row class="ma-5">

    <v-btn color="primary" fab small @click="mSearch()" >
...
export default {
      ...
      watch:{}, 
            ...
            mSearch(){
                  axios.post('api/employee', this.search_Input).then(res => {
                        console.log(res.data)
                  })
            }, 
  				}, 
